...
public class PowerLevel : MonoBehaviour
{
    ...
    public int ReturnMyDancePowerLevel()
    {
        ...
        float myLuck = myStats.luck;
        float myStyle = myStats.style;
        float myRhythm = myStats.rhythm;
        

        return ((int)(myLuck + myStyle + myRhythm)); // instead of returning 0 we probably want to return our current power level
    }
