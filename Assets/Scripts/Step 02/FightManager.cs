...
public class FightManager : MonoBehaviour
{
    ...
    private void DecideWinner(Character teamACharacter, Character teamBCharacter)
    {
        ...
        if (playerOnePowerLevel > playerTwoPowerLevel)
        {
            ...
            BattleLog.Log("Player One Wins", teamAColour);
        ...
        else if (playerOnePowerLevel == playerTwoPowerLevel)
        {
            ...
            FightCompleted(teamACharacter, teamBCharacter, true);
        }
        else
        {
            ...
            BattleLog.Log("Player Two Wins!", teamBColour);
